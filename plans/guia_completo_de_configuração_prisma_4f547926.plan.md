---
name: Guia Completo de Configuração Prisma
overview: Criar um guia completo e detalhado documentando toda a configuração do Prisma neste projeto, incluindo versões, variáveis de ambiente, estrutura de arquivos, scripts e fluxo de trabalho, para servir como padrão para futuros projetos. O resultado final será o arquivo `prisma-setup.md` que será adicionado ao memory-bank do projeto.
todos:
  - id: criar-arquivo-prisma-setup
    content: Criar arquivo `prisma-setup.md` na raiz do projeto com todas as informações analisadas sobre configuração do Prisma
    status: pending
  - id: verificar-completude
    content: "Revisar o guia para garantir que todas as informações necessárias estão incluídas: versões, estrutura de arquivos, variáveis de ambiente, scripts, fluxos de trabalho e troubleshooting"
    status: pending
---
