...
| ------------- | --------------------------------- | ------------------------------------ |
| **Workspace** | `<workspace-root>/.cursor/skills/` | Available only in a specific project |
...
```bash
mkdir -p .cursor/skills/license-header-adder/resources
```

### Step 2: Create the template file

**`.cursor/skills/license-header-adder/resources/HEADER.txt`**:
...
**`.cursor/skills/license-header-adder/SKILL.md`**:
